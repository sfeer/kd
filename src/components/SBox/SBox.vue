<template>
  ...
  >
    ...
    <div
      class="point n"
      :style="pointStyle('n')"
      @mousedown.stop="resizeDragStart('n')"
    ></div>
    <div
      class="point s"
      :style="pointStyle('s')"
      @mousedown.stop="resizeDragStart('s')"
    ></div>
    <div
      class="point w"
      :style="pointStyle('w')"
      @mousedown.stop="resizeDragStart('w')"
    ></div>
    <div
      class="point e"
      :style="pointStyle('e')"
      @mousedown.stop="resizeDragStart('e')"
    ></div>
    <div
      class="point e"
      :style="pointStyle('e')"
    ...
    <div
      class="point ne"
      :style="pointStyle('ne')"
      @mousedown.stop="resizeDragStart('ne')"
    ></div>
    <div
      class="point nw"
      :style="pointStyle('nw')"
      @mousedown.stop="resizeDragStart('nw')"
    ></div>
    <div
      class="point se"
      :style="pointStyle('se')"
      @mousedown.stop="resizeDragStart('se')"
    ></div>
    <div
      class="point sw"
      :style="pointStyle('sw')"
      @mousedown.stop="resizeDragStart('sw')"
    ></div>
    ...
    pointStyle(type) {
      if (this.cBox) {
        ...
        if (type === 'n') {
          ...
          return {
            top: box.y + box.h / 2 + 'px',
            left: box.x + box.w - 20 + 'px',
          }
        } else if (type === 'nw') {
          ...
          return {
            top: box.y + box.h - 30 + 'px',
            left: box.x + box.w - 30 + 'px',
          }
        }
      } else {
        return { display: 'none' }
